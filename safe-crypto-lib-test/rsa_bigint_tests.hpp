...
static std::array<uint8_t, N> bigint_from_hex(const char* s) {
...
TEST_F(BigIntRsaCrossTests, RsaPublicOpMatchesPsa512) {
    ...
    std::array<uint8_t, 768> priv_der_buf{}; // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
    ...
    std::array<uint8_t, 128> m_bytes{}; // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
    ...
    std::array<uint8_t, 128> c_bytes_ours{}; // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
    ...
    std::array<uint8_t, 128> m_recovered{}; // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
