...
struct IaAsmBackend {
    ...
    [[nodiscard]]
    static std::size_t aes_gcm_encrypt_output_size(std::size_t pt_len)   noexcept { return pt_len + ia_asm::detail::aes_gcm_tag_bytes; }
    [[nodiscard]]
    ...
    [[nodiscard]]
    static std::size_t chacha20_encrypt_output_size(std::size_t pt_len)  noexcept { return pt_len + ia_asm::detail::chacha20_poly1305_tag_bytes; }
    [[nodiscard]]
