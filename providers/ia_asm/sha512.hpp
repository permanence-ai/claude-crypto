...
inline void sha512_compress(std::span<uint64_t, 8> state, const uint8_t* block) noexcept // NOLINT(readability-function-cognitive-complexity,readability-function-size)
{
