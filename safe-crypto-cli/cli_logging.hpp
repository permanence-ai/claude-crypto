...
// File sinks are created with mode 0600 (owner-only).
...
// Build an spdlog logger from a parsed JSON config object.
// Throws std::runtime_error if the JSON is malformed or a sink is unknown.
